...
public class JWTConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/profile/delete/{id}", "/api/v1/availability/getdates", "/api/v1/availability/create, /api/v1/availability/getdates").authenticated() // cannot delete without authenication
