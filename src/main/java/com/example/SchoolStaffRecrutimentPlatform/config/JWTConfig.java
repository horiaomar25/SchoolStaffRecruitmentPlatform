...
public class JWTConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/api/v1/profile/delete/{id}","/api/v1/profile/personal",  "/api/v1/profile/update", "/api/v1/assignments/accepted","/api/v1/assignments/{assignmentId}/accept","/api/v1/assignments/{assignmentId}/timesheet","/api/v1/assignments/{assignmentId}/timesheet", "/api/v1/auth/validate").authenticated() // cannot delete without authenication
